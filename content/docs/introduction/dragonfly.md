...
Dragonfly is a metal management system - a tool for managing computer hardware, services and resources.

You can use Dragonfly to install and manage Linux, as well as remotely reinstall and diagnose issues.
<img src="/images/screenshots/login.webp" alt="Dragonfly Machines Dashboard" style="width: 75%; border-radius: 0.5rem; box-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);" />
